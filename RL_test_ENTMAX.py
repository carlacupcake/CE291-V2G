...
model_400 = tf.keras.models.load_model('/Users/john_schafer/Downloads/CE291/CE291-V2G/MODELS/model_ENTMAX_400.h5')
agent = DQNAgent(state_size=3, action_size=21, sequence_length=sequence_length, model=model_400)
episode_durations = []
for episode in range(400):  # Loop over 3 episodes of same "average" day
...
plt.legend()
plt.title('Entropy Maximization 800th Episode')
plt.xlabel('Time')
plt.ylabel('Power')
plt.savefig('800_ENTMAX.png')
plt.show()