...
agent = DQNAgent(state_size=3+1+N, action_size=201, sequence_length=sequence_length)
...
plt.xlabel('Timestep')
plt.ylabel('Energy')
save_path = '/Users/john_schafer/Downloads/CE291/Final_Project/CE291-V2G/perc_action_500trials.png'  # Change the path and filename as needed
